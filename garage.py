#!/usr/bin/python
"""
garage.py - a small daemon to monitor MQTT for state changes
and activates a GPIO that presumably is attached to relay for
toggling a garage door.  It also assumes a reed switch is attached
to determine the garage door state.

Copyright (C) 2016  Mark G. Weber
